...
import com.example.dobee.domain.review.exception.InvalidRatingException;
import com.example.dobee.domain.review.exception.ReviewContentEmptyException;
...
public class ReviewService {
    ...
    public Page<ReviewDto.Response> getMyReviews(Long memberId, String storeName, Integer rating, Pageable pageable) {
        return reviewRepository.findByReviews(memberId, storeName, rating, pageable);
    }
}
